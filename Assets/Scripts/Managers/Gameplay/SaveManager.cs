  ...
  public class SaveManager : MonoBehaviour
  {
    ...
    public bool SaveGame(string playerName, string id)
    {
      try
      {
        ...
        FhLog.I($"Game saved successfully to: {filePath}");
        return true;
      }
      catch (Exception e)
      {
        FhLog.E($"Error saving game: {e.Message}");
        return false;
      }
    }
    ...
    public bool LoadGame(string filePath = null)
    {
      try
      {
        ...
        {
          FhLog.E($"Save file not found: {filePath}");
          return false;
        }
        ...
        {
          FhLog.E("Failed to deserialize save data");
          return false;
        }

        FhLog.I($"Game loaded successfully from: {filePath}");
        return true;
      }
      catch (Exception e)
      {
        FhLog.E($"Error loading game: {e.Message}");
        return false;
      }
    }
    ...
    public bool DeleteSave(string filePath)
    {
      try
      {
        ...
        FhLog.I($"Save file deleted: {filePath}");
        return true;
      }
      catch (Exception e)
      {
        FhLog.E($"Error deleting save file: {e.Message}");
        return false;
      }
    }
    ...
    public List<string> GetAllSaveFiles()
    {
      ...
      {
        FhLog.E($"Error getting save files: {e.Message}");
        return new List<string>();
      }
    }
  }
